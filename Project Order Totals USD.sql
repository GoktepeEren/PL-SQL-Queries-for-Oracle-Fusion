...
Where NVL(pod.PJC_EXPENDITURE_ITEM_DATE, poh.CREATION_DATE) between NVL(:PeriodStartDate, To_Date('22.09.1992','dd.MM.yyyy')) and  NVL(:PeriodEndDate, To_Date('22.09.2092','dd.MM.yyyy')) 
...
From
    ...
    Initcap(ProjectGraphV3_1.ItemDescription) ItemDescription ,
    ...
    From
        ...
        ProjectGraphV3.ItemDescription,
        ...
        Where NVL(pod.PJC_EXPENDITURE_ITEM_DATE, poh.CREATION_DATE) between NVL(:PeriodStartDate, To_Date('22.09.1992','dd.MM.yyyy')) and  NVL(:PeriodEndDate, To_Date('22.09.2092','dd.MM.yyyy')) ) ProjectGraphV3
    ...
    and (Initcap(ProjectGraphV3.Category) IN (:Category) OR 'All' IN (:Category || 'All'))
        -- Authorization: Purchase Analysis Role - Business Unit --
    and (ProjectGraphV3.Company IN 
...
GROUP By ProjectGraphV3_1.ItemDescription
