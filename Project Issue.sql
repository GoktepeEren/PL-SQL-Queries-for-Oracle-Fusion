...
(Select * From 
        ...
        -- and poh.Document_Status IN ('CLOSED','CLOSED FOR INVOICING', 'OPEN',  'CLOSED FOR RECEIVING')
...
(Select * From 
        ...
        Inner Join PO_HEADERS_ALL poh 
            ...
            and dorderrate.CONVERSION_DATE = To_Date(To_Char(poh.CREATION_DATE, 'dd.MM.yyyy'),'dd.MM.yyyy')
        ON poh.PO_HEADER_ID = pol.PO_HEADER_ID 
        -- and poh.Document_Status IN ('CLOSED','CLOSED FOR INVOICING', 'OPEN',  'CLOSED FOR RECEIVING', 'FINALLY CLOSED')
        Inner Join PO_Distributions_ALL pod ON pol.PO_LINE_ID = pod.PO_LINE_ID
        Where invtra.Inventory_Item_Id = pol.Item_ID      
        and invtra.TRANSACTION_UOM = pol.UOM_CODE     
        -- and invtra.TRANSACTION_DATE >= poh.CREATION_DATE
...
Inner Join INV_TRANSACTION_TYPES_VL invtype ON invtra.Transaction_Type_Id = invtype.TRANSACTION_TYPE_ID and UPPER(invtype.Transaction_Type_Name) like '%ISSUE%' 
